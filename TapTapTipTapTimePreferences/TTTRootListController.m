...
- (id)readPreferenceValue:(PSSpecifier *)specifier {
	...
	NSUserDefaults *defaults = [[NSUserDefaults alloc] initWithSuiteName:[specifier properties][@"defaults"]];
	return [defaults objectForKey:[specifier properties][@"key"]] ?: [specifier properties][@"default"];
